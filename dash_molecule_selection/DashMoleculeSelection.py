...
class DashMoleculeSelection(Component):
...
- max_allowed_atoms_percent (number; optional)

- min_allowed_atoms (number; optional)

- nop_selection (boolean; optional)

- preset_selections (dict; optional)

    `preset_selections` is a dict with keys:
...
- style (dict; optional)
    ...
    _type = 'DashMoleculeSelection'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, content=Component.REQUIRED, ftype=Component.UNDEFINED, preset_selections=Component.UNDEFINED, nop_selection=Component.UNDEFINED, min_allowed_atoms=Component.UNDEFINED, max_allowed_atoms_percent=Component.UNDEFINED, height=Component.UNDEFINED, style=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'content', 'ftype', 'height', 'max_allowed_atoms_percent', 'min_allowed_atoms', 'nop_selection', 'preset_selections', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'content', 'ftype', 'height', 'max_allowed_atoms_percent', 'min_allowed_atoms', 'nop_selection', 'preset_selections', 'style']
        ...
        super(DashMoleculeSelection, self).__init__(**args)
